            ...
            <nav class="navbar navbar-expand-lg bg-black navbar-dark py-2 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        <a href="#index" class="nav-item nav-link scrollto active">Home</a>
                        <a href="#about" class="nav-item nav-link scrollto">About</a>
                        <a href="#product" class="nav-item nav-link scrollto">Products</a>
                        <a href="#store" class="nav-item nav-link scrollto">Store</a>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('syrups/img/carousel-1.jpg')}}" alt="Image">
